...
const PROMPTS = {
  ...
  follow_up_today:        'You are a business assistant for an MSME trader. Write 2-3 short paragraphs. First: explain in one natural sentence WHY these customers were selected (the signal logic — overdue, due-soon, or expiring quotes). Second: name the most urgent customer and amount. Third: one specific action. If some customers were suppressed by cooldown, mention it naturally. No markdown, no bullets. Sound like a sharp business operator. Grounded ONLY in provided data.',
