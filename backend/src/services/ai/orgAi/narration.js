...
const PROMPTS = {
  ...
  weekly_trend:           'You are a business assistant for an MSME trader. Analyze weekly collections trend, top moving products, and dormant customers. Write 2-3 lines of executive-level operational guidance grounded ONLY in the provided data. Always recommend a specific next action. Name specific customers or products where data exists. No preamble.',
